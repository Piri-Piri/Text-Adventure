...
public class TextController : MonoBehaviour {
	...
	void cell () {
		text.text = "You are in prison cell, andd you want to escape. There are " +
					"some dirty sheets on the bed, a mirror on the wall, and the door " +
					"is lockaed from the outside.\n\n" +
	...
	void cell_mirror () {
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
					"some dirty sheet on the bed, a mark where the mirror was, " +
	...
	void corridor_0 () {
		text.text = "You're out of your cell, but not out of trouble. " +
					...
					"the courtyard. These's also various detritus on the floor.\n\n" +
	...
	void closet_door () {
		text.text = "You are looking at a closet door, unforunatly it' locked. " +
	...
	void floor () {
		text.text = "Rummagaining around on the dirty floor, you find a hairclip.\n\n" +
	...
	void corridor_1 () {
		text.text = "Still in the corridor. Floor still dirty. Hairclip in hand. " +
					"Now what? You wonder if you look on the closet would succumb to " +
	...
	void stairs_1 () {
		text.text = "Unfortunately weilding a puny hairclip hasn't given you the " +
					"confidence to walk out a coutyard surrounded by armed guards!\n\n" +
	...
	void corridor_2 () {
		text.text = "Back in the corridor, having declined to dress-up as a cleaner.\n\n" +
					"Press C to revisit the Closet, and S to climb up the stairs.";
	...
	void stairs_2 () {
		text.text = "You feel smug for picking the closet door open, and still armed with " +
					...
					"Press R to R to Return to the corridor.";
	...
	void courtyard () {
		text.text = "You walk through the courtyard dressed as a cleaner." +
					"The guard tips his at you as you waltz past, claiming " +
					"your freedom. You heart races as you walk into the sunset.\n\n" +
					"Press P to Play again.";
		
		if 		(Input.GetKeyDown (KeyCode.P))	{ myState = States.cell; }
	}
	#endregion State Handle Methods
}
